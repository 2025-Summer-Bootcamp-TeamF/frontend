...
export default function ReplyManagement() {
  ...
  // 댓글 데이터
  const currentComments: Comment[] = Array.from(
    { length: 100 },
    (_, index) => ({
      id: index + 1,
      reaction: "긍정",
            ...
            <div className="flex flex-row justify-between items-center mb-6">
              <div>
                ...
                <div className="text-[#d9d9d9] text-[15px] font-extralight">
                  해당 페이지에서는 긍정적인 댓글로 분류된 댓글들을 모아볼 수
                  있으며,
                  <br />
                    ...
                    <div className="flex flex-row items-center py-2 hover:bg-[#232335] transition min-w-0">
                      ...
                      <div className="flex-1 flex justify-center items-center gap-3">
                        {(() => {
                          ...
                          if (comment.reaction === "긍정")
                            color = "text-[#3b82f6]";
                          else if (comment.reaction === "부정")
                            color = "text-[#ff0000]";
                          return (
                            <>
                              <div
                                className={`justify-center items-center text-[15px] font-regular truncate pl-1 ${color}`}
                              >
                                {comment.reaction}
                              </div>
                              <div
                                className={`justify-center items-center text-[15px] font-regular truncate ${color}`}
                              >
                      ...
                      <div
                        className="flex-3 flex justify-left items-center text-[#d9d9d9] text-[15px] font-regular truncate ml-12"
