      ...
      <div className="ml-[6vw] flex-1 pr-8 py-8 flex gap-4">
        ...
        >
          <div className="p-6">
            ...
            {/* 감정 분석 도넛 차트 */}
            <div className="w-full flex flex-col items-center justify-center mt-8 mb-2 relative h-[300px]">
              {/* 도넛 차트 뒤쪽 배경 */}
              <div
        ...
        >
          <div className="px-14 py-12 flex flex-col flex-1">
            ...
            <div className="bg-[#23242A] rounded-xl shadow p-8 border-l-8 border-blue-500 mb-6">
              ...
              <div className="flex items-center mb-6">
                <span className="text-[#d9d9d9] text-[15px] font-thin mr-6 flex-1">
                  기존 뉴스 형식에서 벗어난 새로운 보도 방식이라는 평가
                </span>
                <div className="flex gap-2 w-56">
                  <span className="bg-[#278eff] text-[#ffffff] rounded-[20px] px-4 py-2 text-[20px] font-regular"># 미학적 연출</span>
                  <span className="bg-[#278eff] text-[#ffffff] rounded-[20px] px-4 py-2 text-[20px] font-regular"># 감정적 몰입</span>
                </div>
                <span className="text-[#d9d9d9] text-[15px] font-thin ml-6 flex-1">
              ...
              <div className="flex items-center mb-6">
                ...
                <div className="flex gap-2 w-56">
                  <span className="bg-[#278eff] text-[#ffffff] rounded-[20px] px-4 py-2 text-[20px] font-regular"># 창의적 보도</span>
                  <span className="bg-[#278eff] text-[#ffffff] rounded-[20px] px-4 py-2 text-[20px] font-regular"># 스토리텔링</span>
                </div>
                <span className="text-[#d9d9d9] text-[15px] font-thin ml-6 flex-1">
              ...
              {/* Summary */}
              <div className="text-[#d9d9d9] text-[23px] font-medium mt-6 text-right">
            ...
            <div className="bg-[#23242A] rounded-xl shadow p-8 border-l-8 border-red-500">
              <div className="flex items-center text-[28px] font-thin text-[#d9d9d9] mb-6">
              ...
              <div className="flex items-center mb-6">
                ...
                <div className="flex gap-2 w-56">
                  <span className="bg-[#ff0000] text-[#ffffff] rounded-[20px] px-4 py-2 text-[20px] font-regular"># 미학적 연출</span>
                  <span className="bg-[#ff0000] text-[#ffffff] rounded-[20px] px-4 py-2 text-[20px] font-regular"># 감정적 몰입</span>
                </div>
                <span className="text-[#d9d9d9] text-[15px] font-thin ml-6 flex-1">
                  시청자가 보도 내용에 감정적으로 이입하거나 몰입함을 느낌
                </span>
              ...
              <div className="flex items-center mb-6">
                ...
                <div className="flex gap-2 w-56">
                  <span className="bg-[#ff0000] text-[#ffffff] rounded-[20px] px-4 py-2 text-[20px] font-regular"># 창의적 보도</span>
                  <span className="bg-[#ff0000] text-[#ffffff] rounded-[20px] px-4 py-2 text-[20px] font-regular"># 스토리텔링</span>
                </div>
                <span className="text-[#d9d9d9] text-[15px] font-thin ml-6 flex-1">
                  시각적, 음악적 연출이 예술적으로 구성되어 있다는 반응
                </span>
