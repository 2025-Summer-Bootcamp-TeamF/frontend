...
const cardData = [
  {
    img: analysisIcon,
    title: (
      <span className="font-bold text-[#ffffff] text-[43px]">Channel Analysis</span>
    ),
    desc: (
  ...
  },
  {
    img: categoryIcon,
    title: (
      <span className="font-bold text-[#ffffff] text-[43px]">Video Categorize</span>
    ),
    desc: (
  ...
  },
  {
    img: replyIcon,
    title: (
      <span className="font-bold text-[#ffffff] text-[42px]">Reply Management</span>
    ),
    desc: (
