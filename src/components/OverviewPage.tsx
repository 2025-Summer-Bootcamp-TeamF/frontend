  ...
  useEffect(() => {
    const fetchTopVideos = async () => {
      try {
        ...
        const response = await fetch("https://api.cloudsession.cloud/api/videos/top-views", {
          method: "GET",
          headers: {
  ...
  useEffect(() => {
    const fetchSubscriberData = async () => {
      try {
        ...
        const response = await fetch("https://api.cloudsession.cloud/api/channel/subscriber-change", {
          method: "GET",
          headers: {
            "Authorization": `Bearer ${token}`,
            "Content-Type": "application/json",
